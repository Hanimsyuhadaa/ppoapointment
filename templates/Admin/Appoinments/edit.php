	...
	<div class="col-2 text-end">
		<div class="dropdown mx-3 mt-2">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $appoinment->id), 'class' => 'dropdown-item', 'escapeTitle' => false]
            ) ?>
            <?= $this->Html->link(__('List Appoinments'), ['action' => 'index'], ['class' => 'dropdown-item', 'escapeTitle' => false]) ?>
				</div>
		</div>
    </div>
</div>
    ...
    <div class="card-body text-body-secondary">
            ...
            <fieldset>
                <legend><?= __('Edit Appoinment') ?></legend>
                    ...
                    <?php echo $this->Form->control('staff_id', ['options' => $staffs]); ?>
