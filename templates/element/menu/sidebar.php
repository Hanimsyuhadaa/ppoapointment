        ...
        <ul class="list-unstyled components">
            ...
            <?php if ($this->Identity->isLoggedIn()) { ?>
                <li class="menu-item <?= $c_name == 'Users' && $a_name == 'profile' ? 'active' : '' ?>">
                 ...
                 <li class="menu-item <?= $c_name == 'Appoinments' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-regular fa-file-lines"></i> Appoinments'), ['controller' => 'Appoinments', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>
                ...
                <?php if ($this->Identity->isLoggedIn() && $this->Identity->get('user_group_id') == '1') { ?>
                    ...
                    <li class="menu-item <?= $c_name == 'Staffs' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-clipboard-user"></i> Staffs'), ['prefix' => 'Admin', 'controller' => 'Staffs', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>

                    <li class="menu-item <?= $c_name == 'Departments' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-building-circle-check"></i> Departments'), ['prefix' => 'Admin', 'controller' => 'Departments', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>

                    <li class="menu-item <?= $c_name == 'Appoinments' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-regular fa-file-lines"></i> Appoinments'), ['prefix' => 'Admin', 'controller' => 'Appoinments', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
